...
export const handlers = [
  ...
  rest.get("https://*/prod//chat/:chatId", (req, res, ctx) => {
    ...
    const reqPageSize = req.url.searchParams.get("pageSize")
      ? +(req.url.searchParams.get("pageSize") ?? "4")
      : 4;
    let nextToken = req.url.searchParams.get("nextToken")
      ? +(req.url.searchParams.get("nextToken") ?? "0")
      : 0;
      ...
      sources: [
        {
          ...
          metadata: {
            ...
            "original-location":
              "https://osf.io/8mjcy#preprocessed_cases[cases_29404]/42",
            "original-source":
              "OSF: SigmaLaw - Large Legal Text Corpus and Word Embeddings",
            section_index: 57,
          },
        ...
        },
        {
          ...
          metadata: {
            source_location:
              "s3://dev-galileo-corpusnested-processeddatabucket4e25d-zdoz53846j8j/cases/36/case740.txt",
            example: "True",
            "category-id": "36",
            domain: "Legal",
            "original-source-url": "https://osf.io/qvg8s/files/osfstorage",
            ...
            collection: "casefiles",
            "original-location":
              "https://osf.io/8mjcy#preprocessed_cases[cases_29404]/36",
            "original-source":
              "OSF: SigmaLaw - Large Legal Text Corpus and Word Embeddings",
            section_index: 32,
          },
        ...
        },
        {
          ...
          metadata: {
            source_location:
              "s3://dev-galileo-corpusnested-processeddatabucket4e25d-zdoz53846j8j/cases/1/case1181.txt",
            example: "True",
            "category-id": "1",
            domain: "Legal",
            "original-source-url": "https://osf.io/qvg8s/files/osfstorage",
            ...
            collection: "casefiles",
            "original-location":
              "https://osf.io/8mjcy#preprocessed_cases[cases_29404]/1",
            "original-source":
              "OSF: SigmaLaw - Large Legal Text Corpus and Word Embeddings",
            section_index: 2,
          },
        ...
        },
        {
          ...
          metadata: {
            source_location:
              "s3://dev-galileo-corpusnested-processeddatabucket4e25d-zdoz53846j8j/cases/10/case683.txt",
            example: "True",
            "category-id": "10",
            domain: "Legal",
            "original-source-url": "https://osf.io/qvg8s/files/osfstorage",
            ...
            collection: "casefiles",
            "original-location":
              "https://osf.io/8mjcy#preprocessed_cases[cases_29404]/10",
            "original-source":
              "OSF: SigmaLaw - Large Legal Text Corpus and Word Embeddings",
            section_index: 20,
          },
        ...
        },
        {
          ...
          metadata: {
            source_location:
              "s3://dev-galileo-corpusnested-processeddatabucket4e25d-zdoz53846j8j/cases/38/case414.txt",
            example: "True",
            "category-id": "38",
            domain: "Legal",
            "original-source-url": "https://osf.io/qvg8s/files/osfstorage",
            ...
            collection: "casefiles",
            "original-location":
              "https://osf.io/8mjcy#preprocessed_cases[cases_29404]/38",
            "original-source":
              "OSF: SigmaLaw - Large Legal Text Corpus and Word Embeddings",
            section_index: 8,
          },
  ...
  rest.get(
    "https://*/prod//chat/:chatId/message/:messageId/source",
    (req, res, ctx) => {
