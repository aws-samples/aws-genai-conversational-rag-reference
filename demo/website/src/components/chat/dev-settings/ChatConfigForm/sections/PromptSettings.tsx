...
export const PromptSettings: FC = () => {
  ...
  return (
    <SpaceBetween direction="vertical" size="s">
      <TextContent>
        <small>
          Prompt templates are implemented with <Link href='https://handlebarsjs.com/guide/expressions.html#basic-usage' external>Handlebars</Link> for rich-template editing and control.
          In addition to the <Link href='https://handlebarsjs.com/guide/builtin-helpers.html' external>built-in helpers</Link>,
          the templates also support <Link external href='https://assemble.io/helpers/helpers-strings.html'>Strings</Link>
          and <Link external href='https://assemble.io/helpers/helpers-math.html'>Math</Link> helpers.

          Each template also has predefined <Link external href='https://handlebarsjs.com/guide/partials.html'><Icon name="status-info"/>Template Partials</Link> for composing more dynamic and reusable templates.
        </small>
      </TextContent>
