...
export class NxPythonProject extends PythonProject {
  ...
  constructor(options: NxPythonProjectOptions) {
    ...
    if (!(this.root instanceof MonorepoTsProject)) {
      throw new Error('NxPythonProject must be nested in root MonorepoTsProject');
    }
    ...
    this.nx.addBuildTargetFiles([`!{projectRoot}/${dockerDistDir}/**/*`], [`{projectRoot}/${dockerDistDir}`]);
