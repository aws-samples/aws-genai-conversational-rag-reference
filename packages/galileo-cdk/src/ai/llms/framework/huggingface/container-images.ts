...
export class ContainerImages {
  ...
  */
  ...
  static readonly HF_PYTORCH_INFERENCE_LATEST = ContainerImages.HF_PYTORCH_INFERENCE_4_28_1;
  /*
  ...
  */
  ...
  static readonly HF_PYTORCH_LLM_TGI_INFERENCE_LATEST = ContainerImages.HF_PYTORCH_LLM_TGI_INFERENCE_1_1_0;
  /*
  ...
  */
  ...
  static readonly DJL_INFERENCE_DEEPSPEED_LATEST = ContainerImages.DJL_INFERENCE_DEEPSPEED_0_9_2;
}
