...
export interface CognitoBulkCreateUsersCommandFlags extends BaseCognitoCommandFlags {
  group?: string;
  csvFile?: string;
}
...
export const cognitoBulkCreateUsersCommandFlags: FlagInput<CognitoBulkCreateUsersCommandFlags> = {
  ...
  csvFile: Flags.string({
    description: 'The path to the CSV file containing user information (username, email)',
  }),
};
